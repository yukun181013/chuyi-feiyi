...
const inheritorsData = [
  { id: 1, name: '黄文栋', title: '梆鼓咚福建省民间文化优秀十大传承人，中国曲艺志记录传承人（1931—2019）', location: '福建莆田' },
  { id: 2, name: '陈德来', title: '梆鼓咚省级非物质文化遗产代表性传承人', location: '福建莆田荔城区' },
  { id: 3, name: '林秀珍', title: '梆鼓咚省级非物质文化遗产代表性传承人', location: '福建莆田城厢区' },
  { id: 4, name: '郑明辉', title: '梆鼓咚省级非物质文化遗产代表性传承人', location: '福建莆田涵江区' },
  { id: 5, name: '吴春燕', title: '梆鼓咚市级非物质文化遗产代表性传承人', location: '福建莆田秀屿区' },
  { id: 6, name: '黄志远', title: '梆鼓咚市级非物质文化遗产代表性传承人', location: '福建莆田仙游县' },
  { id: 7, name: '黄璟', title: '梆鼓咚第五代传承人，唯一代表性传承人，莆田学院音乐学院副教授，首位将传统曲目记谱为五线谱的传承者', location: '福建莆田' },
  { id: 8, name: '林季君', title: '梆鼓咚第五代传承人，莆田学院音乐学院客座教授，省级中学音乐学科教学带头人，专注青少年传承传播', location: '福建莆田' },
]
